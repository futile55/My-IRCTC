...
<form method="POST" action="book.php"><h2><font face="Cambria"><b>BOOK TICKETS</b></font></h2><br>
<font face="Cambria" size="4">
<b>FROM</b> (Station Name)
	<select name="x">  
...
<b>DATE</b> (DD/MM/YYYY)
<input type="date" name="z"><br><br>
<b>Select Journey Class</b><br><br>
<input type="radio" name="a">Sleeper
<input type="radio" name="a">General
<input type="radio" name="a">AC 1st tier
<input type="radio" name="a">AC 2nd tier
<input type="radio" name="a">AC 3rd tier<br>
<br>
...
<br><a href="http://www.facebook.com/Saurabhranjan" title="Saurabh on Facebook"><font size="4" color="black" face="cambria">Saurabh Singh</a> </b> <br><hr>
