...
<ul>
   ...
   <li class='has-sub '><a href=''><span>Journey Planner</span></a>
      <ul>
         <li class='has-sub '><a href=''><span>Interstate Journey</span></a>
         </li>
         <li class='has-sub '><a href=''><span>Intrastate Journey</span></a>
            <ul>
               <li><a href=''><span>Free Services</span></a></li>
               <li><a href=''><span>Paid Schemes</span></a></li>
            </ul>
         </li>
      </ul>
   </li>
...
<td bgcolor="white">
<font size="5" color="black" face="cambria"><center><b>AVAILABLE TRAINS</b><br><br>
...
if(empty($x) || empty($y) || empty($z) || empty($a) || empty($b))
echo "Please fill all the necessary fields.!!";
else 
{
	mysql_connect("localhost","root","");
	mysql_select_db("irctc");
	$q="SELECT * FROM trains where fr='$x' and tr='$y';";	
...
echo "<td><b><center>TRAIN NAME </td>";
echo "<td><b><center> ARRIVAL TIME </td>";
echo "<td><b><center> DEPARTURE TIME </td>";
echo "<td><b><center> AVAILABLE SEATS</td>";
echo "<td><b> <font size=3.5>&nbsp &nbsp &nbsp&nbsp &nbsp  FROM &nbsp &nbsp &nbsp &nbsp &nbsp  TO &nbsp &nbsp  &nbsp &nbsp &nbsp &nbsp NUMBER OF TICKETS </td>";
echo "</tr>";
...
echo "<td><br><center><font size=4><form action='btick.php'  method= 'post'>
<input type='text' name='x' size='8' value=$x>
<input type='text' name='y' size='8' value=$y>
<input type='integer' name='b' size='4' value=$b>
<input type='submit' value='Book Tickets' value=$p></form></td>";
echo "</tr></table>";
}
			}
}
