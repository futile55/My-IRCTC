...
<td bgcolor="white">
<font size="4" color="black" face="cambria"><center><b>MESSAGE</b><br>
<?php
$x=$_POST['x'];
$y=$_POST['y'];
$b=$_POST['b'];
$user=$_SESSION['name'];
	...
	$q="SELECT * FROM trains where fr='$x' and tr='$y' and genseats>='$b';";	
	$result=mysql_query($q);
	$count=mysql_num_rows($result);
		if($count==0)
			echo "$b tickets are unavailable in this train.!!";
		else
		{
			$row=mysql_fetch_array($result);
			$h=$row[0];
			echo "$b tickets were booked successfully.!!<br>";
			echo "Your PNR Number is ";
			$pnr=mt_rand(1000000,9999999);
			echo "<b>$pnr";
			$q2="UPDATE trains SET genseats = genseats-'$b' WHERE fr='$x' and tr='$y' and genseats>='$b';";	
			mysql_query($q2);
			mysql_connect("localhost","root","");
			mysql_select_db("irctc");
			$q3="INSERT INTO tickets VALUES($pnr,$b,$h,'$user');";	
			mysql_query($q3);
		}
?>
</td></tr></table>
